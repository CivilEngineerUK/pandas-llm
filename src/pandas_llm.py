...
class PandasLLM(pd.DataFrame):
    ...
    def __init__(self,
        ...
        llm_kwargs: A dictionary of parameters to be used with the OpenAI API.
        ...
        Args:
            ...
            llm_kwargs (dict, optional): LLM engine parameters. Defaults to model=gpt-3.5-turbo and temperature=0.2".
            ...
            custom_prompt (str, optional): if prompt_override is False, the custom prompt will be added to the default src prompt. Defaults to "".
        ...
        self.llm_kwargs = llm_kwargs or {}
        self.model = self.llm_kwargs.get("model")
        self.temperature = self.llm_kwargs.get("temperature")
...
import numpy as np
    ...
    def prompt(self, request: str):
        ...
        self._save("temp/prompt_cmd.json", json.dumps(self.llm_kwargs['messages'], indent=4))
